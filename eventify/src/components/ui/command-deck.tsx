...
export default function CommandDeck() {
    return (
        <ContextMenu>
            <ContextMenuTrigger className="grid h-[180px] w-[360px] place-items-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50/50 p-4 text-center text-sm font-medium text-gray-500 hover:bg-gray-100 hover:border-gray-400 cursor-pointer transition-all">
