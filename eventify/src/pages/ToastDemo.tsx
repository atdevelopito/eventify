...
export default function ToasterDemo() {
    ...
    return (
        <div className="min-h-screen bg-background">
            <Navbar />
            <div className="p-6 space-y-6 max-w-4xl mx-auto pt-20">
                        ...
                        <div className="flex flex-wrap gap-4">
                            {['default', 'success', 'error', 'warning'].map((variantKey) => (
                                <Button
                                    ...
                                    className={`border-${variantKey === 'default' ? 'border' : variantKey
                                        }-600 text-${variantKey === 'default' ? 'foreground' : variantKey
